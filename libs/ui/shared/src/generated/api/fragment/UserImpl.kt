...
public class UserImpl() : Fragment<User> {
  ...
  public override fun adapter(): Adapter<User> = UserImpl_ResponseAdapter.User.obj()

  public override fun rootField(): CompiledField = CompiledField.Builder(
    name = "data",
    type = api.type.User.type
  )
  .selections(selections = UserSelections.__root)
  .build()

  public companion object {
    public fun Data(resolver: FakeResolver = DefaultFakeResolver(__Schema.all),
        block: (BuilderScope.() -> UserMap)? = null): User = buildFragmentData(
      UserImpl_ResponseAdapter.User,
      UserSelections.__root,
      "User",
      block,
      resolver,
      api.type.User.type,
