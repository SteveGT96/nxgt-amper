...
public class RoleImpl() : Fragment<Role> {
  ...
  public override fun adapter(): Adapter<Role> = RoleImpl_ResponseAdapter.Role.obj()

  public override fun rootField(): CompiledField = CompiledField.Builder(
    name = "data",
    type = api.type.Role.type
  )
  .selections(selections = RoleSelections.__root)
  .build()

  public companion object {
    public fun Data(resolver: FakeResolver = DefaultFakeResolver(__Schema.all),
        block: (BuilderScope.() -> RoleMap)? = null): Role = buildFragmentData(
      RoleImpl_ResponseAdapter.Role,
      RoleSelections.__root,
      "Role",
      block,
      resolver,
      api.type.Role.type,
