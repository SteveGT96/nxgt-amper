...
import api.type.UserConnection
import api.type.UserEdge
...
public object GetUsersQuerySelections {
  ...
  private val __users: List<CompiledSelection> = listOf(
        ...
        CompiledField.Builder(
          name = "edges",
          type = UserEdge.type.list().notNull()
        ).selections(__edges)
        .build()
      )
  ...
  public val __root: List<CompiledSelection> = listOf(
        CompiledField.Builder(
          name = "users",
          type = UserConnection.type.notNull()
        ).arguments(listOf(
